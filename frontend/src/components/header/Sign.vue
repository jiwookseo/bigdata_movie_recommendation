      ...
      <div v-if="form === 'register'" class="register">
        ...
        <div class="sign_div">
          ...
          <div class="register_form">
            ...
            <input
              id="password1"
              v-model="reg_password1"
              type="password"
              class="mt-30 signup--input"
              required
            />
            ...
            <div class="occupation mt-30">
              ...
              <select id="occupation" v-model="reg_occupation" required>
                <option
                  v-for="(occupation, i) of occupationList"
                  :key="occupation + i"
                  :value="i"
                >{{ occupation }}</option>
              </select>
...
export default {
  ...
  methods: {
    ...mapActions("user", ["setLogin", "setRegister"]),
    closeModal(func) {
    ...
    chkAge() {
      if (
        typeof this.reg_age === "number" &&
        this.ages[this.reg_age] !== undefined
      ) {
        this.err_age = "";
      } else {
    ...
    chkOccupation() {
      if (
        typeof this.reg_occupation === "number" &&
        this.occupationList[this.reg_occupation] !== undefined
      ) {
        this.err_occupation = "";
      } else {
...
.signup--input {
  ...
  &:focus {
    border-bottom: rgba(255, 183, 0, 1) 2px solid;
    transition: all 0.5s ease;
    outline: none;
    min-height: 16px;
    max-height: 16px;
